...
CodeMirror.defineSimpleMode("ada",{
  start: [
    ...
    {regex: /(is|begin|loop|record)$/, token: "keyword", indent: true},
    {regex: /\b(abort|else|new|return|elsif|reverse|abstract|accept|entry|select|access|exception|of|separate|aliased|exit|some|all|others|subtype|for|out|synchronized|array|function|overriding|tagged|generic|package|task|begin|goto|pragma|terminate|body|private|then|if|procedure|type|case|protected|constant|interface|until|is|raise|use|declare|range|delay|limited|record|when|delta|loop|while|digits|renames|with|do|requeue)\b/i, token: "keyword"},
